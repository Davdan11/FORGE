...
export function RouteThumb({ route, className = "", strokeWidth = 2.4 }: {
  ...
  return (
    <svg viewBox="0 0 100 100" className={className} role="img" aria-label="Route shape" preserveAspectRatio="xMidYMid meet">
...
function EmptyThumb({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 100" className={className} role="img" aria-label="No route" preserveAspectRatio="xMidYMid meet">
