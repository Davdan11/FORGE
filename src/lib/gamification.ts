...
const RIDE_BADGES: Badge[] = [
  ...
  once("ride", "worlds_lap", "endurance", ["Worlds lap", "The 2026 Worlds circuit on Mount Royal, finished."], ["Tour des Mondiaux", "Le circuit des Mondiaux 2026 sur le mont Royal, terminé."], routeDone("c23")),
  once("ride", "worlds_tt", "endurance", ["Against the clock", "The 39 km 2026 Worlds time trial, finished."], ["Contre la montre", "Le contre-la-montre des Mondiaux 2026, 39 km, terminé."], routeDone("c24")),
  once("ride", "worlds_race", "endurance", ["World champion's day", "The whole 277 km elite race of the 2026 Worlds, finished."], ["Une journée de champion du monde", "La course élite des Mondiaux 2026 au complet, 277 km, terminée."], routeDone("c25")),
