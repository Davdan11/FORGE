...
export const INGREDIENTS: Ingredient[] = [
  ...
  I({ id: "turkey-mince", name: "Lean turkey mince", cat: "protein", n: [150, 19, 0, 0, 8, 0], ok: MEAT, adj: "spiced",
  ...
  I({ id: "beef-mince", name: "Lean beef mince (5%)", cat: "protein", n: [137, 21, 0, 0, 5, 0], ok: MEAT, adj: "seared",
  ...
  I({ id: "courgette", name: "Courgette", cat: "veg", n: [17, 1.2, 3.1, 2.5, 0.3, 1], ok: VEGAN_GF, cook: { roast: "Roast the courgette chunks 18 min at 220 °C.", stirfry: "Stir-fry 3 min.", grill: "Grill the courgette slices 3 min per side." } }),
