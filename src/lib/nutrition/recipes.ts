...
const TEMPLATES: Template[] = [
  ...
  { id: "bowl", slot: ["lunch", "dinner"], minutes: 20, cuisine: "Grain bowl",
    ...
    intro: "Heat the oven to 220 °C for the roasted element and start the grain.", finish: "Build the bowl by colour: grain, protein, roasted and raw veg side by side, sauce last. Lemon and salt to taste.", tip: "Cook the grain and roast the veg in double quantities — bowls are the easiest meal-prep there is." },
  ...
  { id: "curry", slot: ["dinner"], minutes: 30, cuisine: "Curry",
    ...
    intro: "Start the rice. In a wide pan, fry 2 tbsp of curry paste in the oil for 1 min until it smells toasty.", finish: "Simmer until the sauce coats a spoon; lime juice, coriander, salt to taste. Serve over the rice.", tip: "Light coconut milk keeps this under control; full-fat adds ~120 kcal per portion." },
